...
//
//    @Bean
//    public JWTAuthorizationFilter authorizationFilter(AuthenticationConfiguration authenticationConfiguration) throws Exception {
//        return new JWTAuthorizationFilter(authenticationConfiguration.getAuthenticationManager());
//    }
//
//    @Bean
//    public JWTAuthenticationFilter authenticationFilter(AuthenticationConfiguration authenticationConfiguration) throws Exception {
//        return new JWTAuthenticationFilter(authenticationConfiguration.getAuthenticationManager(), userService, passwordEncoder);
//    }
